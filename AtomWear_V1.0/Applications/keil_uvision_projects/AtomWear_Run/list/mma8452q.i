...
#line 2 "..\\..\\..\\Software\\Source\\mma8452q\\mma8452q.c"
...
#line 3 "..\\..\\..\\Software\\Source\\mma8452q\\mma8452q.c"
...
#line 4 "..\\..\\..\\Software\\Source\\mma8452q\\mma8452q.c"
...
#line 5 "..\\..\\..\\Software\\Source\\mma8452q\\mma8452q.c"
...
#line 6 "..\\..\\..\\Software\\Source\\mma8452q\\mma8452q.c"
...
#line 7 "..\\..\\..\\Software\\Source\\mma8452q\\mma8452q.c"


byte SlaveAddressIIC = 0x1c;
...
void IIC_RegWrite(byte address, byte reg, byte val)
{
	...
	twi_master_transfer(address, send, 2, ((_Bool)1));
}
...
byte IIC_RegRead(byte address, byte reg)
{
	...
	address = (address<<1) & 0xFE;
	twi_master_transfer(address, &reg, 1, ((_Bool)0)); 
	
	address = address | 0x01;
	twi_master_transfer(address, &b, 1, ((_Bool)1)); 
...
void IIC_RegReadN(byte address, byte reg, uint8_t len, uint8_t *value)
{
	...
	address = address | 0x01;
	twi_master_transfer(address, value, len, ((_Bool)1)); 
}
...
void MMA845x_Active ()
{
  IIC_RegWrite(SlaveAddressIIC, 0x2A, (IIC_RegRead(SlaveAddressIIC, 0x2A) | 0x01));
}
...
void MMA845x_Standby (void)
{
  ...
  n = IIC_RegRead(SlaveAddressIIC, 0x2A);
  IIC_RegWrite(SlaveAddressIIC, 0x2A, n & ~0x01);
}
...
void MMA845x_Init (void)
{
	if(IIC_RegRead(SlaveAddressIIC, 0x0D) == 0x2A)
	{
  ...
  MMA845x_Standby();
	...
	IIC_RegWrite(SlaveAddressIIC, 0x2A, 0x14);
	IIC_RegWrite(SlaveAddressIIC, 0x2B, 0x12);
...
uint16_t mma8452q_get_mo_value(void)
{
    ...
    if(IIC_RegRead(SlaveAddressIIC, 0x00)&0x08)
	{
		IIC_RegReadN(SlaveAddressIIC, 0x01, 6, value);
