#line 1 "..\\..\\..\\Software\\Source\\bmp180\\bmp180.c"
...
#line 17 "..\\..\\..\\Software\\Source\\bmp180\\bmp180.c"
...
#line 18 "..\\..\\..\\Software\\Source\\bmp180\\bmp180.c"
...
#line 19 "..\\..\\..\\Software\\Source\\bmp180\\bmp180.c"
...
#line 20 "..\\..\\..\\Software\\Source\\bmp180\\bmp180.c"
...
#line 21 "..\\..\\..\\Software\\Source\\bmp180\\bmp180.c"
...
#line 22 "..\\..\\..\\Software\\Source\\bmp180\\bmp180.c"
...
int bmp180_init(struct bmp180_t *bmp180)
{
   ...
   p_bmp180 = bmp180;                    
   p_bmp180->sensortype = (char) 0;
   p_bmp180->dev_addr = (0xEE>>1);    
  
   p_bmp180->bus_write = IIC_write;
   p_bmp180->bus_read = IIC_read;
   p_bmp180->delay_msec = nrf_delay_ms;
    
   comres += p_bmp180->bus_read(p_bmp180->dev_addr, 0xD0, &data, 1);   


   p_bmp180->chip_id = ((data & 0xFF) >> 0);
   p_bmp180->number_of_samples = 1;
   p_bmp180->oversampling_setting = 0;
   p_bmp180->sw_oss = 0;
	if (p_bmp180->chip_id == 0x55) {
		 
		p_bmp180->sensortype = 85;
		 
		comres += p_bmp180->bus_read(p_bmp180->dev_addr, 0xD1, &data, 1);


		 
		p_bmp180->ml_version = ((data & 0x0F) >> 0);

		 
		p_bmp180->al_version = ((data & 0xF0) >> 4);

        xprintf("read chip_ID successful~\r\n");
		bmp180_get_cal_param();  
	}
    else
    {
        xprintf("read ID error\r\n");
    }
   return comres;
}
...
int bmp180_get_cal_param(void)
{
   ...
   comres = p_bmp180->bus_read(p_bmp180->dev_addr, 0xaa, data, 22);
...
unsigned short bmp180_get_ut()
{
   ...
   comres = p_bmp180->bus_write(p_bmp180->dev_addr, 0xF4, &ctrl_reg_data, 1);


   p_bmp180->delay_msec(wait_time);
   comres += p_bmp180->bus_read(p_bmp180->dev_addr, 0xF6, data, 2);
...
unsigned long bmp180_get_up()
{
   ...
   int comres = 0;
	...
	if (p_bmp180->chip_id == 0x55 && p_bmp180->sw_oss == 1 && 		p_bmp180->oversampling_setting == 3) {

		for (j = 0 ; j < 3; j++) 
         {
             				
            ctrl_reg_data = 0x34 + (p_bmp180->oversampling_setting << 6);
			comres = p_bmp180->bus_write(p_bmp180->dev_addr, 0xF4, &ctrl_reg_data, 1);
			p_bmp180->delay_msec(2 + (3 << (p_bmp180->oversampling_setting)));
			comres += p_bmp180->bus_read(p_bmp180->dev_addr, 0xF6, data, 3);
   ...
   {
	if (p_bmp180->chip_id == 0x55 && p_bmp180->sw_oss == 0) 
     {
		ctrl_reg_data = 0x34 + (p_bmp180->oversampling_setting << 6);
		comres = p_bmp180->bus_write(p_bmp180->dev_addr, 0xF4, &ctrl_reg_data, 1);
		p_bmp180->delay_msec(2 + (3 << (p_bmp180->oversampling_setting)));
