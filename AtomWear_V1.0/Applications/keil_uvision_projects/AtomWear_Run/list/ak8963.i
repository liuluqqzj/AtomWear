...
#line 2 "..\\..\\..\\Software\\Source\\AK8963C\\ak8963.c"
...
#line 3 "..\\..\\..\\Software\\Source\\AK8963C\\ak8963.c"
...
#line 4 "..\\..\\..\\Software\\Source\\AK8963C\\ak8963.c"
...
#line 5 "..\\..\\..\\Software\\Source\\AK8963C\\ak8963.c"
...
#line 6 "..\\..\\..\\Software\\Source\\AK8963C\\ak8963.c"
...
#line 7 "..\\..\\..\\Software\\Source\\AK8963C\\ak8963.c"
#line 1 "..\\..\\..\\Software\\Include\\ak8963.h"



#line 5 "..\\..\\..\\Software\\Include\\ak8963.h"



#line 18 "..\\..\\..\\Software\\Include\\ak8963.h"

#line 25 "..\\..\\..\\Software\\Include\\ak8963.h"
...
#line 8 "..\\..\\..\\Software\\Source\\AK8963C\\ak8963.c"
...
#line 9 "..\\..\\..\\Software\\Source\\AK8963C\\ak8963.c"
...
void ak8963_write(uint8_t device_addr, uint8_t register_addr, uint8_t *register_data, uint8_t write_length)
{
    ...
    else
    {
        ...
        twi_master_transfer(device_addr, send_rec, write_length + 1, ((_Bool)1)); 
    }
}
...
uint8_t ak8963_read(uint8_t device_addr, uint8_t register_addr, uint8_t *register_data, uint8_t read_length)
{
    ...
    {
        device_addr = (device_addr << 1) & 0xFE;
        twi_master_transfer(device_addr, &register_addr, 1, ((_Bool)0)); 
        
        device_addr = device_addr | 0x01;
        twi_master_transfer(device_addr, register_data, read_length, ((_Bool)1)); 
        return 1;
    }
}
...
uint8_t ak8963_Read(uint8_t device_addr, uint8_t register_addr)
{
	...
	device_addr = device_addr | 0x01;
    twi_master_transfer(device_addr, &temp, 1, ((_Bool)1)); 
...
void ak8963_init(void)
{
    ...
    ak8963_read(0x0C, 0x00, buffer, 1);
    if(buffer[0] != 0x48)
    {
	...
	buffer[0] = 0x10;
    ak8963_write(0x0C, 0x0A, &buffer[0], 1);
...
void self_test(void)
{
	...
	temp = 0x40;
	ak8963_write(0x0C, 0x0C, &temp, 1);
	
	temp = 0x18;
	ak8963_write(0x0C, 0x0A, &temp, 1);
	
	nrf_delay_ms(10);
	while(!(ak8963_Read(0x0C, 0x02) & 0x01));
	
	ak8963_read(0x0C, 0x03, value, 6);
...
void ak8963_test(void)
{
	...
	while(1)
	{
		...
		do
		{
			ak8963_read(0x0C, 0x02, &temp, 1);
		}while(!(temp & 0x01));
		
		ak8963_read(0x0C, 0x03, value, 6);
		
		ak8963_read(0x0C, 0x09, &temp, 1);
