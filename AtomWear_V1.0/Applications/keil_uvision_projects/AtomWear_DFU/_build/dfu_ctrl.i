#line 1 "Source\\dfu_ctrl\\dfu_ctrl.c"
...
#line 2 "Source\\dfu_ctrl\\dfu_ctrl.c"
...
#line 3 "Source\\dfu_ctrl\\dfu_ctrl.c"
#line 1 ".\\Include\\nrf_delay.h"
...
#line 4 "Source\\dfu_ctrl\\dfu_ctrl.c"
#line 1 ".\\Include\\nrf_gpio.h"
...
#line 5 "Source\\dfu_ctrl\\dfu_ctrl.c"
...
#line 6 "Source\\dfu_ctrl\\dfu_ctrl.c"
...
#line 7 "Source\\dfu_ctrl\\dfu_ctrl.c"
...
#line 8 "Source\\dfu_ctrl\\dfu_ctrl.c"
...
#line 9 "Source\\dfu_ctrl\\dfu_ctrl.c"

_Bool region1_is_valid()
{
    uint32_t state = *((uint32_t *)(0x0003FC00 + 0));
    if(state == 0x00000001)
        return 1;
    else
        return 0;
...
static void interrupts_disable(void)
{
    ...
    interrupt_setting_mask = ((NVIC_Type *) ((0xE000E000UL) + 0x0100UL) )->ISER[0];
...
void bootloader_app_start()
{
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 63, (uint8_t*) "Source\\dfu_ctrl\\dfu_ctrl.c"); } while (0); } } while (0);
    bootloader_util_app_start(0x14000);
}
