#line 1 "Source\\ble_lib\\app_timer.c"
...
#line 14 "Source\\ble_lib\\app_timer.c"
...
#line 15 "Source\\ble_lib\\app_timer.c"
#line 16 "Source\\ble_lib\\app_timer.c"
#line 1 ".\\Include\\nrf51_bitfields.h"
...
#line 17 "Source\\ble_lib\\app_timer.c"
#line 1 ".\\Include\\nrf_soc.h"
...
#line 18 "Source\\ble_lib\\app_timer.c"
#line 19 "Source\\ble_lib\\app_timer.c"
#line 1 ".\\Include\\nrf_delay.h"
...
#line 20 "Source\\ble_lib\\app_timer.c"
#line 21 "Source\\ble_lib\\app_timer.c"
...
#line 22 "Source\\ble_lib\\app_timer.c"
...
#line 23 "Source\\ble_lib\\app_timer.c"
...
static void timeout_handler_exec(timer_node_t * p_timer)
{
    if (m_evt_schedule_func != 0)
    {
        ...
        do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 350, (uint8_t*) "Source\\ble_lib\\app_timer.c"); } while (0); } } while (0);
    }
    else
    {
...
static void compare_reg_update(app_timer_id_t timer_id_head_old)
{
    ...
    if (m_timer_id_head != ((app_timer_id_t)(0 - 1)))
    {
        ...
        if (timer_id_head_old == ((app_timer_id_t)(0 - 1)))
        {
