#line 1 "Source\\flash_ctrl\\flash_ctrl.c"
...
#line 2 "Source\\flash_ctrl\\flash_ctrl.c"
#line 1 ".\\Include\\nrf.h"
...
#line 3 "Source\\flash_ctrl\\flash_ctrl.c"
#line 1 ".\\Include\\nrf_gpio.h"
...
#line 4 "Source\\flash_ctrl\\flash_ctrl.c"
...
#line 5 "Source\\flash_ctrl\\flash_ctrl.c"
...
#line 6 "Source\\flash_ctrl\\flash_ctrl.c"
...
#line 7 "Source\\flash_ctrl\\flash_ctrl.c"
...
#line 8 "Source\\flash_ctrl\\flash_ctrl.c"
...
#line 9 "Source\\flash_ctrl\\flash_ctrl.c"
...
void flash_page_erase(uint32_t *page_address)
{
    ...
    ((NRF_NVMC_Type *) 0x4001E000UL)->CONFIG = ((0x02UL) << (0UL));
    ...
    ((NRF_NVMC_Type *) 0x4001E000UL)->ERASEPAGE = (uint32_t)page_address;
    ...
    ((NRF_NVMC_Type *) 0x4001E000UL)->CONFIG = ((0x00UL) << (0UL));
...
void system_app_pages_erase(uint32_t page_address, uint8_t pages_count)
{
    ...
    for(i = 0; i < pages_count; i++)
    {
        ...
        ((NRF_NVMC_Type *) 0x4001E000UL)->ERASEPAGE = page_address;     
        while (((NRF_NVMC_Type *) 0x4001E000UL)->READY == (0UL));
...
void flash_word_write(uint32_t *address, uint32_t value)
{
    ...
    ((NRF_NVMC_Type *) 0x4001E000UL)->CONFIG = ((0x01UL) << (0UL));
...
uint8_t system_page_refresh(uint8_t cur_page, uint8_t page_data[], uint32_t data_length)
{
    ...
    byte_count = 0;
    word_value = 0;
    address = (uint32_t *)(0x14000 + cur_page*1024);
    ...
    {    
        ...
        *address = word_value;  
        ...
        if( (cur_page*1024 + byte_count) == get_dfu_amount())
        {
            cur_state = 0x02;
            break;
        }
