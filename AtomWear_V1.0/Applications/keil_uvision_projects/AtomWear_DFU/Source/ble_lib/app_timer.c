...
////////////////////////
#define RTC_PRESCALER             31  /* (32khz/10^3 - 1) */
                        ...
                        app_timer_evt_schedule_func_t evt_schedule_func)
{
    ...
    m_evt_schedule_func = evt_schedule_func;    //指向超时调度函数

    // Initialize timer node array
    m_node_array_size = max_timers;             //  节点长度
    mp_nodes          = p_buffer;               //  定时器节点
